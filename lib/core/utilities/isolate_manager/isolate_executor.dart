...
import 'package:azorin_test/core/utilities/isolate_manager/scheduler.dart';
import 'package:azorin_test/core/utilities/isolate_manager/task.dart';
import 'package:azorin_test/core/utilities/isolate_manager/thread.dart';
...
abstract class IsolateExecutor {
  ...
  factory IsolateExecutor.fifo() => _IsolateManager(threadPoolSize: 1)..threadPoolSize = 1;
}
